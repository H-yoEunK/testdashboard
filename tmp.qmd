...
format: 
  dashboard:
    scrolling: true
    logo: data:image/png;base64,{{img_logo}}
freeze: true
--- 
...
img_logo = image_to_base64('houseprice_logo.png')
img_scenery = image_to_base64('scenery.png')
img_roof = image_to_base64('roof.jfif')
img_exterior = image_to_base64('exterior1.png')
```
